...
package com.company.thesissummer.service.orders.orderIns
...
class InsQR {
    ...
    public Object getQR(Map<String, Object> params) {
        ...
        OrderIns orderIns = params['entity'] as OrderIns;

        return [['QRcodeimage': getPDF417Barcode(orderIns.getCreator().getLogin())]]
