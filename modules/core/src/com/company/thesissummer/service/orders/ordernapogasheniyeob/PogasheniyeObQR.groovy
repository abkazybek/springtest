...
package com.company.thesissummer.service.orders.ordernapogasheniyeob
...
class PogasheniyeObQR {
    ...
    public Object getQR(Map<String, Object> params) {
        ...
        OrderPogashOb orderPogashOb = params['entity'] as OrderPogashOb;

        return [['QRcodeimage': getPDF417Barcode(orderPogashOb.getCreator().getLogin())]]
