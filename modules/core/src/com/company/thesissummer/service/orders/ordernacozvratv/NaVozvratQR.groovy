...
package com.company.thesissummer.service.orders.ordernacozvratv
...
class NaVozvratQR {
    ...
    public Object getQR(Map<String, Object> params) {
        ...
        OrderNaVozvrat orderNaVozvrat = params['entity'] as OrderNaVozvrat;

        return [['QRcodeimage': getPDF417Barcode(orderNaVozvrat.getCreator().getLogin())]]
