...
package com.company.thesissummer.service.orders.ordervozvratvgu
...
class VozvratVGuQR {
    ...
    public Object getQR(Map<String, Object> params) {
        ...
        OrderVozvratvGu orderVozvratvGu = params['entity'] as OrderVozvratvGu;

        return [['QRcodeimage': getPDF417Barcode(orderVozvratvGu.getCreator().getLogin() )]]
