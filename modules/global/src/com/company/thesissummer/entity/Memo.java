...
@Table(name = "THESISSUMMER_MEMO")
@Entity(name = "thesissummer$Memo")
@Listeners("thesis_DocEntityListener")
@EnableRestore
@TrackEditScreenHistory
@PrimaryKeyJoinColumn(name = "CARD_ID", referencedColumnName = "ID")
public class Memo extends Doc implements HasDetailedDescription {

    private static final long serialVersionUID = 8094765383721472530L;
