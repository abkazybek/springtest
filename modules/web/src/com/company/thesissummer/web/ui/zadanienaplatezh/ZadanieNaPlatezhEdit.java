...
public class ZadanieNaPlatezhEdit<T extends ZadanieNaPlatezh> extends AbstractDocEditor<T> {
    ...
    @Inject
    public LookupPickerField<ExtEmployee> orderReceiver;
    ...
    protected void onInit(BeforeShowEvent event) {
        ...
        if (cardDs == null) {
            ...
            List<ExtEmployee> employees = dataManager.load(ExtEmployee.class)
                    ...
                    .list();
            if (employees.size() != 0) {
                getEditedEntity().setOrderReceiver(employees.get(0));
            ...
            Proc proc = dataManager.load(Proc.class)
                    ...
                    .parameter("code", "ZadanieKod")
                    .view("browse")
                    .one();

            ProcRole initiatiator = dataManager.load(ProcRole.class)
            ...
            cardInitiatior.setProcRole(initiatiator);

            cardInitiatior.setUser(employees.get(0).getUser());
            ...
            cardOznakomitel.setUser(employees.get(0).getUser());
